...
class Test4040(sciunit.Test):
	...
	self.required_capabilities = (Produce4040,) 

    score_type = BooleanScore # This test's 'judge' method will return a BooleanScore.  
    
    def generate_prediction(self, model):
        [control4040,schiz4040] = model.produce_4040() # The model has this method if it inherits from the 'Produce4040' capability.
...
class Test3030(sciunit.Test):
	...
	sciunit.Test.__init__(self,observation,name) # Call the base constructor.  
	self.required_capabilities = (Produce3030,) 

    score_type = BooleanScore # This test's 'judge' method will return a BooleanScore.  
    
    def generate_prediction(self, model):
        [control3030,schiz3030] = model.produce_3030() # The model has this method if it inherits from the 'Produce3030' capability.
...
class Test2020(sciunit.Test):
	...
	sciunit.Test.__init__(self,observation,name) # Call the base constructor.  
	self.required_capabilities = (Produce2020,) 

    score_type = BooleanScore # This test's 'judge' method will return a BooleanScore.  
    
    def generate_prediction(self, model):
        [control2020,schiz2020] = model.produce_2020() # The model has this method if it inherits from the 'Produce2020' capability.
...
class Test2040(sciunit.Test):
	...
	sciunit.Test.__init__(self,observation,name) # Call the base constructor.  
	self.required_capabilities = (Produce2040,) 

    score_type = BooleanScore # This test's 'judge' method will return a BooleanScore.  
    
    def generate_prediction(self, model):
        [control2040,schiz2040] = model.produce_2040() # The model has this method if it inherits from the 'Produce2040' capability.
...
class Test4020(sciunit.Test):
	...
	sciunit.Test.__init__(self,observation,name) # Call the base constructor.  
	self.required_capabilities = (Produce4020,) 

    score_type = BooleanScore # This test's 'judge' method will return a BooleanScore.  
    
    def generate_prediction(self, model):
        [control4020,schiz4020] = model.produce_4020() # The model has this method if it inherits from the 'Produce4020' capability.
