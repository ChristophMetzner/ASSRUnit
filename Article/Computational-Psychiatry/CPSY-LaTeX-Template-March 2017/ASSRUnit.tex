...
\subtitle{ASSRUnit - A Case Study} %% Optional subtitle
% 
...
{Christoph Metzner \affil{1},
Tuomo M\"aki-Marttunen\affil{2}, \\
Bartosz Zurowski\affil{3},\and Volker Steuber\affil{1}}

\affiliation{1}{Centre for Computer Science and Informatics Research, University of Hertfordshire, Hatfield, United Kingdom}
% 
% %ie.
...
\affiliation{2}{Simula Research Laboratory and Center for Cardiological Innovation, Oslo, Norway }
\affiliation{3}{Center for Integrative Psychiatry,  University of L\"ubeck, L\"ubeck, Germany}
% 
% %ie
...
% %Canada}
% 
\correspondingauthor{Christoph Metzner}{c.metzner@herts.ac.uk}
% 
% % ie,
% %\correspondingauthor{Ritwik K. Niyogi}{ritwik.niyogi@gatsby.ucl.ac.uk}
% 
\keywords{Biomarkers, Endophenotypes, Computational Models, }
% 
% %ie
